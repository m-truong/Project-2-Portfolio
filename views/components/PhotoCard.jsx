  ...
  render() {
    return (
      <div className="photo-card">
        ...
        <hr />
        <a
          href="https://www.linkedin.com/in/michael-truong-86939bb5/"
          target="_blank"
        >
        ...
        <a href="https://www.instagram.com/miketruong781/" target="_blank">
          <i className="fab fa-instagram-square fa-lg"></i> @miketruong781 on
          Instagram
        </a>
        <hr />
        <p>
          <i class="fas fa-mobile-alt fa-lg" />{" "} Mobile: 781-974-6193
        </p>
        <hr />
      </div>
    );
